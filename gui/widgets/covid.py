...
class widget_covid(widget):
    ...
    def draw(self, surface, frame_count):
        ...
        self.write(self.position, surface, f"Last Updated: {self.last_updated}", self.font_orkneyl, 16*scale, 40*scale + (self.position[0])*400, 335*(self.height / 380)+380*(self.position[1]))
