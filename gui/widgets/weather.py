...
class widget_weather(widget):
    ...
    def draw(self, surface, frame_count):
        ...
        self.write_centre(self.position, surface, f"Live Weather", self.font_orkneyb, 30*scale, -110*scale)
        self.write_centre(self.position, surface, f"{self.descNow}", self.font_orkneyl, 25*scale, -38*scale)
        self.write_centre(self.position, surface, f"Temperature: {self.tempNow}°C", self.font_orkneyl, 25*scale, 65*scale)
        self.write_centre(self.position, surface, f"Feels Like: {self.feelsNow}°C", self.font_orkneyl, 25*scale, 100*scale)
